                ...
                <section>
                    <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>Mahaveer Event Hall</h5><!--content title-->
                                                <p>
                                            ...
                                            <div class="modaltext2 col-md-12">
                                                ...
                                                an adjoining lounge for pre or post event entertaining.
                                                </p>
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Event Hall</h1><!--location title-->
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>Mahaveer IT Hub</h5><!--content title-->
                                                <p>
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">IT Hub</h1><!--location title-->
                            <p class="location">Mahaveer Institute Of Science & Technology</p><!--location secondary content-->
                            <p class="definition">
                        ...
                        <div class="modal fade" id="argyle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">Play Ground</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>Mahaveer Conference Hall</h5><!--content title-->
                                                <p>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Mahaveer Play Ground</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
