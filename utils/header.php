    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>Mahaveer Institute of Science & Technology</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                A standout amongst the most noteworthy occasions of your college life is the college fest. 
                They are meant to be unforgettable. 
                Organizing a college fest is a momentous 
                accomplishment and the diligent work pays 
                off when you feel the happiness on the essences 
                of your mates and educators.College fests are a memorable part of our lives where extravagant decorations, 
                sizzling celebrities/ stars and most importantly many, 
                fun-driven events add to the flavor.
                </p>
                <p id="dateAndTime"></p>
            </div>
        </div>
