                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Dance</h1><!--event content title-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Coding</h1><!--event content title-->
                            <p class="location"><!--event content location-->
                            Mahaveer Institute of science & Technolgy, Vyasapuri, Bandlaguda, Hyderabad. 
                            </p>
                            <p class="definition"><!--event content definition-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Best Manager</h1><!--event content title-->
                            <p class="location"><!--event content location-->
                            Mahaveer Institute of science & Technolgy, Vyasapuri, Bandlaguda, Hyderabad.
                            </p>
                            <p class="definition"><!--event content definition-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
                            <h1 class="title">Sports Events</h1><!--event content title-->
                            <p class="location"><!--event content location-->
                            Mahaveer Institute of science & Technolgy, Vyasapuri, Bandlaguda, Hyderabad.
                            </p>
                            <p class="definition"><!--event content definition-->
                            ...
                            <hr class="customline2"><!--css modified horizontal line-->
                            <button type="button" data-toggle="events2.php" class="btn btn-default btn-lg"><!--view details button (no function implemented)-->
                                View Details  <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span><!--arrow right glyphicon-->
                            </button>
                       </div><!--subcontent div-->
                    </div><!--container div-->
